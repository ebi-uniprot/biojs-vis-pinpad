...
var Category = function(pinPadViewer, catTitle) {
    ...
    var categoryContainer = category.pinPadViewer.padContainer.append('div')
        .classed('up_pp_category-container', true);

    category.header = categoryContainer.append('div')
    ...
    category.padContainer = categoryContainer.append('div')
