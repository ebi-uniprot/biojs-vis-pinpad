...
var init = function(pinPad) {
    ...
    pinPad.dispatcher.ready({initialCategories: pinPad.categories});
};
...
var PinpadViewer = function(opts){
    ...
    pinPad.categories = [];
    pinPad.dispatcher = d3.dispatch("ready", "duplication", "add", "remove");
...
PinpadViewer.prototype.addElement = function(toPin) {
    ...
    var exists = toPin.id && _.some(pinPad.categories, function(cat) {
        return _.some(cat.elements, function(elem) {
