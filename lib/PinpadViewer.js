...
PinpadViewer.prototype.addElement = function(toPin) {
    var pinPad = this;
    //add category
    var exist = _.some(pinPad.categories, function(cat) {return cat.title === toPin.category; });
    if (!exist) {
...
PinpadViewer.removeElement = function(id) {

};

PinpadViewer.removeCategory = function(elem) {
